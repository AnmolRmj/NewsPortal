...
<div id="menu-bar">
    ...
    <span style="color:white;" id="dateTime">00:00 am</span>

<script>
    // Function to update the time and temperature
    function updateTimeAndTemperature() {
        ...
        const apiKey = 'd94b94436d8c0c183a69ad1a93672351';
        const latitude = 27.7086208;
        const longitude = 85.3180416;
        ...
        fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${apiKey}`)
            ...
            .then(data => {
                ...
                // Update the content of the "dateTime" span with time and temperature
                dateTimeElement.textContent = `${timeString} / ${temperatureString}`;
            })
            .catch(error => {
    ...
    // Call updateTimeAndTemperature initially to set the time and temperature
    updateTimeAndTemperature();
    setInterval(updateTimeAndTemperature, 10000); // Update every second
</script>
