...
if($_SESSION["user_role"] == 2){ // editor
  include "config.php";
  $post_id = $_GET['id'];
  $sql2 = "SELECT author FROM post WHERE post_id = {$post_id}";
      ...
      ?>
        ...
        <form action="save-update-post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <textarea name="postdesc" class="form-control"  required rows="5"><?php echo $row['description'];?></textarea></div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php
// Assuming $row['post_img'] contains the file path
...
<?php elseif (in_array($fileType, ['mp4', 'avi', 'mkv'])): ?>
    <!-- Display video -->
    <video controls>
        <source src="<?php echo $row['post_img']; ?>" type="video/mp4">
